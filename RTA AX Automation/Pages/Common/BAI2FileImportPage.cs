...
{
    [ActionClass]
    public class BAI2FileImportPage
    {
        #region PageControls
        ...
        [ActionMethod]
        public void SetImportFileFolderCheckBox(bool value)
        {
            UIControls.SetControlValue("Import all files in this folder", "CheckBox", value.ToString(), new UIAXCWindow());

        }

         [ActionMethod]
        public void SetReconcileImportCheckBox(bool value)
        {
            UIControls.SetControlValue("Reconcile after import", "CheckBox", value.ToString(), new UIAXCWindow());
        ...
        [ActionMethod]
        public void SetStatmentFormatText(string value)
        {
            UIControls.SetControlValue("Statement format", "Edit", value, new UIAXCWindow());

        }

        [ActionMethod]
        public void SetFileNamelocationText(string value)
        {
            UIControls.SetControlValue("Select file", "Edit", value, new UIAXCWindow());
