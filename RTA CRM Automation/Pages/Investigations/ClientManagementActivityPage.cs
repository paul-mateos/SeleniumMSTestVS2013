...
{
    [ActionClass]
    public class ClientManagementActivityPage : IFramePage
    {
        private static string frameId = "contentIFrame0";        
        private static string pageTitle = "Client Management Activity:";
        private static int waitsec = Properties.Settings.Default.IMPLICIT_WAIT_SECONDS;

        public ClientManagementActivityPage(IWebDriver driver)
            : base(driver, ClientManagementActivityPage.frameId)
        {
        ...
        */
        ...
        {
            return UICommon.GetTextFromElement("#description_d span", driver);
        }
    }
}
